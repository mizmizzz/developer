...
const Profile = () => {
  ...
  const infoData = [
    ...
    },
    {
      ...
      content: [
        {text:"안녕하세요!"},
        {text:"팀과 함께 문제를 해결하고, <br className='mo_br_768'/>함께 성장하고 싶은 신입 개발자 <b>문지은</b>입니다."},
        {text:"저는 개발 과정을 공유하며 <b>소통</b>하는 것을 좋아합니다."},
        {text:"문제 상황에서 망설임이나 두려움 보다는 <br className='mo_br_768'/>빠르게 <b>최선의 해결방법</b>을 모색합니다."},
        {text:"다른 개발자가 보아도 <b>쉽게 이해하고 <br className='mo_br_768'/>수정할 수 있는 코드</b>가 좋은 코드라고 생각합니다."},
        {text:"내가 작성하지 않은 코드를 파악하고 수정하는 것도 <br className='mo_br_768'/>공부라고 생각하고 <b>유연하게 대처</b>하려고 노력합니다."}
      ],
    },
  ];
